...
## previous bounds without competing events constraint
#CDE(0)
...
#NDE(0)/SDE(0) 
NDE_0_NoConstraint <- analyze_graph(cmpdag,effect = "p{Y(M(X = 0), X = 1) = 1} - p{Y(M(X = 0), X = 0) = 1}", constraint = NULL)
NDE_0_NoConstraint_bnds <- optimize_effect_2(NDE_0_NoConstraint)
#NDE(1)/SDE(1) 
